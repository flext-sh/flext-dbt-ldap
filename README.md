...
2. Confirm parent MRO chain via `pyproject.toml` `dependencies` filtered by `flext-*` (excluding `flext-dbt-ldap` self).
...
- Public extensions exposed by this project: `FlextDbtLdapUtilitiesSync`, `FlextDbtLdapTestError`, `FlextDbtLdapUtilities`, `FlextDbtLdapModelsDimensions`, `FlextDbtLdap`, `FlextDbtLdapConstantsTransformation` (+26 more).
