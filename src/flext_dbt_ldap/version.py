"""Project metadata for flext dbt ldap."""
...
class FlextDbtLdapVersion(FlextProjectVersion):
    """Structured metadata for the flext dbt ldap distribution."""

    @classmethod
    def current(cls) -> FlextDbtLdapVersion:
        """Return canonical metadata loaded from pyproject.toml."""
        return cls.from_metadata(_metadata_obj)


VERSION: Final[FlextDbtLdapVersion] = FlextDbtLdapVersion.current()
...
__all__ = ["VERSION", "FlextDbtLdapVersion", "__version__", "__version_info__"]
