    ...
    class DbtLdap:
        ...
        class Ldap:
            ...
            class LdapIntegration(
                FlextMeltanoProtocols.Service[m.DbtLdapPipelineResult],
                Protocol,
            ):
            ...
            @runtime_checkable
            class Modeling(
                FlextMeltanoProtocols.Service[m.DbtModelDefinition],
                Protocol,
            ):
            ...
            class Transformation(
                FlextMeltanoProtocols.Service[m.UserDimension],
                Protocol,
            ):
            ...
            @runtime_checkable
            class Performance(
                FlextMeltanoProtocols.Service[m.PerformanceAnalysis],
                Protocol,
            ):
