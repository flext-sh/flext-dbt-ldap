"""FLEXT DBT LDAP Simple API - Simplified factory functions.

Provides simplified factory functions for creating DBT LDAP components.
Integrates with flext-ldap for client operations.
