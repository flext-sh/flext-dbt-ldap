...
| 4 | medium | high | `uv-missing-dependency-cooldown` | `pyproject.toml` | 609 | |
...
Dados brutos: `~/semgrep-violations/by-repo/flext-sh__flext-dbt-ldap.json`
