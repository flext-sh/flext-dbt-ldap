...
**Package:** `flext_dbt_ldap` · deps: `flext-cli`, `flext-core`, `flext-ldap`,
`flext-ldif`, `flext-meltano`

## Overview

dbt models for LDAP data transformation. Thin driver over `flext-meltano` dbt runner
(ADR-006).
